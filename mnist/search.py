...
from config import STYLEGAN_INIT, SEARCH_LIMIT, STYLEMIX_SEED_LIMIT, INIT_PKL, STYLEMIX_LAYERS, FRONTIER_PAIRS, INTERPOLATION_ALPHA
...
class mimicry:
    ...
    def __init__(self, class_idx=None, w0_seed=0, stylemix_seed=0, search_limit=SEARCH_LIMIT, step_size=1):
        ...
        print(f"Search: Initial trunc_psi is {self.state['params']['trunc_psi']}")
